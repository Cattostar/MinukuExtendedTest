...
public class SensorDataRecord implements DataRecord {
   ...
   // public float accelerometerY;
    ...
    public SensorDataRecord(float accelerometer[3]
    //, float accelerometerY,float accelerometerZ
    ) {
        this.creationTime = new Date().getTime();
        this.accelerometer[3] = accelerometer[3];
    ...
    public void setAccelerometer(float accelerometer[3]) {
        this.accelerometer[3] = accelerometer[3];
    }
    ...
    public String toString() {
        return "Acc:" + this.accelerometer[3];
    }
}